...
export interface ApiBatimentBatiment extends Struct.CollectionTypeSchema {
  collectionName: 'batiments';
  info: {
    displayName: 'batiment';
    pluralName: 'batiments';
    singularName: 'batiment';
  };
  options: {
...
export interface ApiDateporteouerteDateporteouerte
  extends Struct.SingleTypeSchema {
  collectionName: 'datesporteouertes';
  info: {
    displayName: 'dateporteouerte';
    pluralName: 'datesporteouertes';
    singularName: 'dateporteouerte';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_PO: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dateporteouerte.dateporteouerte'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFiliereFiliere extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    matiere_enseignees: Schema.Attribute.Relation<
      'manyToMany',
      'api::matiereenseignee.matiereenseignee'
    >;
    nomdelafiliere: Schema.Attribute.String;
    PresFiliere: Schema.Attribute.RichText &
...
export interface ApiMatiereenseigneeMatiereenseignee
  extends Struct.CollectionTypeSchema {
  collectionName: 'matieresenseignees';
  info: {
    displayName: 'MatiereEnseign\u00E9e';
    pluralName: 'matieresenseignees';
    singularName: 'matiereenseignee';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    NomMatiere: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNomlyceeNomlycee extends Struct.SingleTypeSchema {
  collectionName: 'nomslycee';
  info: {
    displayName: 'nomlycee';
    pluralName: 'nomslycee';
    singularName: 'nomlycee';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSalleSalle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    batiment: Schema.Attribute.Relation<'manyToOne', 'api::batiment.batiment'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::salle.salle'> &
      Schema.Attribute.Private;
    NumeroSalle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTypedecoursTypedecours extends Struct.SingleTypeSchema {
  collectionName: 'typesdecours';
  info: {
    displayName: 'typedecours';
    pluralName: 'typesdecours';
    singularName: 'typedecours';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    typologie: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTypedesalleTypedesalle extends Struct.SingleTypeSchema {
  collectionName: 'typesdesalle';
  info: {
    displayName: 'typedesalle';
    pluralName: 'typesdesalle';
    singularName: 'typedesalle';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::batiment.batiment': ApiBatimentBatiment;
      'api::dateporteouerte.dateporteouerte': ApiDateporteouerteDateporteouerte;
